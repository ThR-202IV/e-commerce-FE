    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
        ...
        <div className="flex-1 ">
          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((itemsz, index) => (
                <button
                  onClick={() => setSize(itemsz)}
                  className={`border-2 py-2 px-4 bg-gray-100 ${
                    itemsz === size ? "border-[#a34cef]" : ""
                  }`}
                  key={index}
                >
                  {itemsz}
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            ...
            <p>Cash on dleivery available</p>
      ...
      <div className="mt-20">
        <div className="flex">
          ...
          <p className="border px-5 py-3 text-sm">Reviews (43)</p>
        </div>
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt
            libero eaque est autem quas dicta sunt nam fugiat aut blanditiis
            tempora beatae molestiae in placeat aliquid, praesentium ut
            voluptatum
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nihil hic
            perspiciatis corporis minima ipsum alias, nam dolorum provident
            distinctio commodi obcaecati, magni reiciendis dicta ullam nostrum
            qui consequatur asperiores
          </p>
        </div>
      </div>
